...
var author$project$Card$orderedDeck = function () {
	var suits = _List_fromArray(
		[author$project$Card$Spades, author$project$Card$Hearts, author$project$Card$Diamonds, author$project$Card$Clubs]);
	...
	return A2(
		...
		function (r) {
			return A2(
				elm$core$List$map,
				function (s) {
					return _Utils_Tuple2(r, s);
				},
				suits);
		},
		ranks);
}();
var author$project$Card$NewDeck = function (a) {
	return {$: 'NewDeck', a: a};
};
...
var author$project$Card$shuffleDeck = function () {
	var initDeck = elm_community$random_extra$Random$List$shuffle(author$project$Card$orderedDeck);
	return A2(elm$random$Random$generate, author$project$Card$NewDeck, initDeck);
}();
var author$project$Main$Ante = {$: 'Ante'};
var author$project$Main$CardMsg = function (a) {
	return {$: 'CardMsg', a: a};
};
var author$project$Main$Human = {$: 'Human'};
var author$project$Main$IsBetting = {$: 'IsBetting'};
var author$project$Main$IsWaiting = {$: 'IsWaiting'};
var author$project$Main$NPC = {$: 'NPC'};
var elm$core$Platform$Cmd$map = _Platform_map;
var author$project$Main$init = function (_n0) {
	var initPlayer = {cards: _List_Nil, handValue: elm$core$Maybe$Nothing, name: 'INIT', stack: 1000, state: author$project$Main$IsWaiting, type_: author$project$Main$NPC};
	return _Utils_Tuple2(
		{
			communityCards: _List_Nil,
			deck: author$project$Card$orderedDeck,
			gameStage: author$project$Main$Ante,
			minBet: 0,
			players: _List_fromArray(
				[
					_Utils_update(
					initPlayer,
					{name: 'Player', state: author$project$Main$IsBetting, type_: author$project$Main$Human}),
					_Utils_update(
					initPlayer,
					{name: 'NPC1'}),
					_Utils_update(
		...
		A2(elm$core$Platform$Cmd$map, author$project$Main$CardMsg, author$project$Card$shuffleDeck));
};
var author$project$Main$ReceivedScoresFromJS = function (a) {
	return {$: 'ReceivedScoresFromJS', a: a};
};
...
var author$project$Ports$scoresFromPokerJS = _Platform_incomingPort(
	'scoresFromPokerJS',
...
var author$project$Main$subscriptions = function (_n0) {
	return author$project$Ports$scoresFromPokerJS(author$project$Main$ReceivedScoresFromJS);
};
var author$project$Main$IsAllIn = {$: 'IsAllIn'};
var author$project$Main$IsFolded = {$: 'IsFolded'};
var author$project$Main$Flop = {$: 'Flop'};
var author$project$Main$PreFlop = {$: 'PreFlop'};
var author$project$Main$River = {$: 'River'};
var author$project$Main$Turn = {$: 'Turn'};
...
var author$project$Main$deal = function (model) {
	var getPlayersCards = F2(
		function (players, cards) {
			var cardPairs = A2(elm_community$list_extra$List$Extra$groupsOf, 2, cards);
			return A3(
				elm$core$List$map2,
				F2(
					function (p, cp) {
		...
		case 'Ante':
			return _Utils_update(
				model,
				{
					deck: A2(
						elm$core$List$drop,
						elm$core$List$length(model.players) * 2,
						model.deck),
					gameStage: author$project$Main$PreFlop,
					players: A2(getPlayersCards, model.players, model.deck)
				});
		case 'PreFlop':
			return _Utils_update(
				model,
				{
					communityCards: A2(elm$core$List$take, 3, model.deck),
					deck: A2(elm$core$List$drop, 3, model.deck),
					gameStage: author$project$Main$Flop
				});
		case 'Flop':
			return _Utils_update(
				model,
				{
					communityCards: A2(
						...
						model.communityCards),
					deck: A2(elm$core$List$drop, 1, model.deck),
					gameStage: author$project$Main$Turn
				});
		case 'Turn':
			return _Utils_update(
				model,
				{
					communityCards: A2(
						...
						model.communityCards),
					deck: A2(elm$core$List$drop, 1, model.deck),
					gameStage: author$project$Main$River
				});
		default:
			return model;
	}
};
var author$project$Card$parseForScorerJS = function (card) {
	var rankToStr = function (rank) {
		switch (rank.$) {
			case 'Two':
				return 2;
			case 'Three':
...
var author$project$Card$toScorerFormat = function (cards) {
	return elm$core$List$unzip(
		A2(elm$core$List$map, author$project$Card$parseForScorerJS, cards));
};
...
var author$project$Ports$sendToPokerScorerJS = _Platform_outgoingPort(
	'sendToPokerScorerJS',
	elm$json$Json$Encode$list(
		function ($) {
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$json$Json$Encode$list(elm$json$Json$Encode$int)(a),
...
var author$project$Main$getPlayerHandScore = function (model) {
	var pocketCards = function () {
		var _n0 = elm$core$List$head(model.players);
		if (_n0.$ === 'Just') {
			var p = _n0.a;
			return p.cards;
		} else {
	...
	var possibleHands = A2(
		elm$core$List$map,
		author$project$Card$toScorerFormat,
		A2(
			elm$core$List$filter,
			function (x) {
				return elm$core$List$length(x) === 5;
			},
			elm_community$list_extra$List$Extra$subsequences(
				A2(elm$core$List$append, pocketCards, model.communityCards))));
	return author$project$Ports$sendToPokerScorerJS(possibleHands);
};
var author$project$Main$isBetting = function (p) {
	return _Utils_eq(p.state, author$project$Main$IsBetting);
};
...
var author$project$Main$ifBetting = elm_community$list_extra$List$Extra$updateIf(author$project$Main$isBetting);
var author$project$Main$isHuman = function (p) {
	return _Utils_eq(p.type_, author$project$Main$Human);
};
...
var author$project$Main$raise = F2(
	function (model, pBet) {
		var seed = elm$random$Random$initialSeed(pBet);
		return _Utils_update(
			model,
			{
				players: A2(
					...
					function (p) {
						return _Utils_update(
							p,
							{
								stack: author$project$Main$isHuman(p) ? A3(elm$core$Basics$clamp, 0, 9999999999, p.stack - pBet) : A2(
									elm$random$Random$step,
									A2(elm$random$Random$int, model.minBet, p.stack),
									seed).a,
								state: author$project$Main$IsWaiting
							});
					},
					model.players),
				pot: A3(elm$core$Basics$clamp, 0, 9999999999, model.pot + (model.minBet + pBet))
			});
	});
		...
		switch (msg.$) {
			...
			case 'TempBet':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'Deal':
				var updatedModel = author$project$Main$deal(model);
				return _Utils_Tuple2(
					updatedModel,
					author$project$Main$getPlayerHandScore(updatedModel));
			case 'AllIn':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							players: A2(
								author$project$Main$ifBetting,
								function (p) {
									return _Utils_update(
										p,
										{stack: 0, state: author$project$Main$IsAllIn});
								},
								model.players),
							pot: function () {
								var _n1 = A2(elm_community$list_extra$List$Extra$find, author$project$Main$isBetting, model.players);
								if (_n1.$ === 'Just') {
									var player = _n1.a;
									return player.stack + model.pot;
								} else {
									return model.pot;
								}
							}()
			...
			case 'CheckCall':
				return _Utils_Tuple2(
					A2(author$project$Main$raise, model, 0),
					elm$core$Platform$Cmd$none);
			case 'Raise':
				var bet = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Main$raise, model, bet),
					elm$core$Platform$Cmd$none);
			case 'Fold':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							players: A2(
								...
								function (p) {
									return _Utils_update(
										p,
										{cards: _List_Nil, handValue: elm$core$Maybe$Nothing, state: author$project$Main$IsFolded});
								},
								model.players)
						}),
					elm$core$Platform$Cmd$none);
...
var author$project$Main$Deal = {$: 'Deal'};
var author$project$Main$Fold = {$: 'Fold'};
var author$project$Main$Raise = function (a) {
	return {$: 'Raise', a: a};
};
var author$project$Main$TempBet = function (a) {
	return {$: 'TempBet', a: a};
};
...
var author$project$Main$betInput = F3(
	function (model, player, comnAttrs) {
		return A2(
								...
								[
									...
									A2(
										...
										rundis$elm_bootstrap$Bootstrap$Button$onClick(
											author$project$Main$Raise(
												A3(elm$core$Basics$clamp, 0, player.stack, model.tempBet))),
										A2(elm$core$List$cons, rundis$elm_bootstrap$Bootstrap$Button$success, comnAttrs)),
									_List_fromArray(
										[
											elm$html$Html$text('Bet/Raise')
										])),
										...
										[
											...
											A2(
												...
												A2(
													...
													author$project$Main$TempBet))),
											rundis$elm_bootstrap$Bootstrap$Form$Input$attrs(
											_List_fromArray(
												[
													elm$html$Html$Attributes$min(
													elm$core$String$fromInt(model.minBet)),
													elm$html$Html$Attributes$max(
													elm$core$String$fromInt(player.stack - model.minBet))
												])),
											_Utils_eq(player.state, author$project$Main$IsBetting) ? rundis$elm_bootstrap$Bootstrap$Form$Input$disabled(false) : rundis$elm_bootstrap$Bootstrap$Form$Input$disabled(true)
										]))
								]))
						]))
				]));
		...
		if (p.$ === 'Just') {
			...
			var comnAttrs = _List_fromArray(
				[
					...
					_Utils_eq(player.state, author$project$Main$IsBetting) ? rundis$elm_bootstrap$Bootstrap$Button$disabled(false) : rundis$elm_bootstrap$Bootstrap$Button$disabled(true)
				]);
			return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('controlsHeader'),
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('controlsButtons')
							]),
						_List_fromArray(
							[
								A2(
								...
								A2(
									elm$core$List$cons,
									rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$Deal),
									A2(elm$core$List$cons, rundis$elm_bootstrap$Bootstrap$Button$primary, comnAttrs)),
								_List_fromArray(
									[
								...
								A2(
									elm$core$List$cons,
									rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$Fold),
									A2(elm$core$List$cons, rundis$elm_bootstrap$Bootstrap$Button$primary, comnAttrs)),
								_List_fromArray(
									[
										elm$html$Html$text('Fold')
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Button$button,
								A2(
									elm$core$List$cons,
									rundis$elm_bootstrap$Bootstrap$Button$onClick(
										author$project$Main$Raise(0)),
									A2(elm$core$List$cons, rundis$elm_bootstrap$Bootstrap$Button$primary, comnAttrs)),
								_List_fromArray(
									[
										elm$html$Html$text('Call/Check')
									]))
							])),
						A2(elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						...
						_List_fromArray(
							[
								A3(author$project$Main$betInput, model, player, comnAttrs)
							])),
						A2(elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						elm$html$Html$div,
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								'Stack: $' + elm$core$String$fromInt(player.stack))
							])),
						A2(
						rundis$elm_bootstrap$Bootstrap$Button$button,
						A2(
							elm$core$List$cons,
							rundis$elm_bootstrap$Bootstrap$Button$onClick(
								author$project$Main$Raise(player.stack)),
							A2(elm$core$List$cons, rundis$elm_bootstrap$Bootstrap$Button$danger, comnAttrs)),
						_List_fromArray(
							[
								elm$html$Html$text('All In')
							]))
					]));
		} else {
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Error: No player found in controlsView ')
					]));
		}
	});
var author$project$Main$Community = {$: 'Community'};
var author$project$Card$cardToStr = function (card) {
	var rankToStr = function (rank) {
		switch (rank.$) {
			case 'Ace':
				return 'A';
	...
	switch (card.b.$) {
		case 'Spades':
			var r = card.a;
			var _n1 = card.b;
			return rankToStr(r) + 'S';
		case 'Hearts':
			var r = card.a;
			var _n2 = card.b;
			return rankToStr(r) + 'H';
		case 'Diamonds':
			var r = card.a;
			var _n3 = card.b;
			return rankToStr(r) + 'D';
		default:
			var r = card.a;
			var _n4 = card.b;
			return rankToStr(r) + 'C';
	}
};
...
var author$project$Main$cardsView = F3(
	function (typeOfCards, cards, gameStage) {
		var cardImg = function (cardStr) {
			return A2(
				elm$html$Html$img,
				_List_fromArray(
					[
						elm$html$Html$Attributes$src('./img/' + (cardStr + '.png')),
		...
		var cardsFace = A2(
			...
			A2(elm$core$List$map, author$project$Card$cardToStr, cards));
		if (!cards.b) {
			return _List_fromArray(
				[
					cardImg('empty')
...
var author$project$Main$gameArea = function (model) {
	return _List_fromArray(
		[
			A2(
			rundis$elm_bootstrap$Bootstrap$Grid$col,
			...
			A3(author$project$Main$cardsView, author$project$Main$Community, model.communityCards, model.gameStage)),
			A2(
			rundis$elm_bootstrap$Bootstrap$Grid$col,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							'$' + elm$core$String$fromInt(model.pot))
						]))
				]))
		]);
};
var author$project$Main$handInfoText = function (model) {
	var handDescription = function () {
		var _n0 = elm$core$List$head(model.players);
		if (_n0.$ === 'Just') {
			var p = _n0.a;
			var _n1 = p.handValue;
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text(handDescription)
			]));
};
var rundis$elm_bootstrap$Bootstrap$General$Internal$LG = {$: 'LG'};
var rundis$elm_bootstrap$Bootstrap$Grid$Col$lg = A2(rundis$elm_bootstrap$Bootstrap$Grid$Internal$width, rundis$elm_bootstrap$Bootstrap$General$Internal$LG, rundis$elm_bootstrap$Bootstrap$Grid$Internal$Col);
...
var rundis$elm_bootstrap$Bootstrap$Text$alignMd = function (dir) {
	return {dir: dir, size: rundis$elm_bootstrap$Bootstrap$General$Internal$MD};
};
var rundis$elm_bootstrap$Bootstrap$Text$alignMdCenter = rundis$elm_bootstrap$Bootstrap$Text$alignMd(rundis$elm_bootstrap$Bootstrap$Internal$Text$Center);
var rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$p2 = elm$html$Html$Attributes$class('p-2');
var author$project$Main$cardAttrs = _List_fromArray(
	[
...
var author$project$Main$evenOrOddFromList = F2(
	function (fn, lst) {
		return A2(
			elm$core$List$filterMap,
			elm$core$Basics$identity,
				...
				F2(
					function (i, x) {
						return A2(
							...
							0) ? elm$core$Maybe$Just(x) : elm$core$Maybe$Nothing;
					}),
				lst));
	});
var author$project$Main$evensFrom = function (lst) {
	return A2(author$project$Main$evenOrOddFromList, elm$core$Basics$eq, lst);
};
var author$project$Main$playerAreaBtm = function (model) {
	return A2(
		elm$core$List$map,
		function (p) {
			return A2(
				rundis$elm_bootstrap$Bootstrap$Grid$col,
				author$project$Main$cardAttrs,
				A2(
					elm$core$List$append,
					A3(author$project$Main$cardsView, p.type_, p.cards, model.gameStage),
					_List_fromArray(
						[
							A2(
							elm$html$Html$div,
		...
		author$project$Main$evensFrom(model.players));
};
var elm$core$Basics$neq = _Utils_notEqual;
var author$project$Main$oddsFrom = function (lst) {
	return A2(author$project$Main$evenOrOddFromList, elm$core$Basics$neq, lst);
};
var author$project$Main$playerAreaTop = function (model) {
	return A2(
		elm$core$List$map,
		function (p) {
			return A2(
		...
		author$project$Main$oddsFrom(model.players));
};
var author$project$Main$tableAttrs = _List_fromArray(
	[
		A2(elm$html$Html$Attributes$style, 'background-color', 'darkgreen'),
		A2(elm$html$Html$Attributes$style, 'text-align', 'center'),
...
var rundis$elm_bootstrap$Bootstrap$General$Internal$Around = {$: 'Around'};
...
var rundis$elm_bootstrap$Bootstrap$Grid$Row$aroundXs = A2(rundis$elm_bootstrap$Bootstrap$Grid$Internal$rowHAlign, rundis$elm_bootstrap$Bootstrap$General$Internal$XS, rundis$elm_bootstrap$Bootstrap$General$Internal$Around);
...
var author$project$Main$view = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		author$project$Main$tableAttrs,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('pokerHeader')
							]))
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('pokerMain')
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('pokerTable')
									]))
							]),
						_List_fromArray(
							[
								...
								author$project$Main$playerAreaTop(model)),
								A2(
								rundis$elm_bootstrap$Bootstrap$Grid$row,
								_List_Nil,
								author$project$Main$gameArea(model)),
								A2(
								rundis$elm_bootstrap$Bootstrap$Grid$row,
								_List_fromArray(
									[rundis$elm_bootstrap$Bootstrap$Grid$Row$aroundXs]),
								author$project$Main$playerAreaBtm(model))
							])),
						A2(
						rundis$elm_bootstrap$Bootstrap$Grid$col,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('pokerControls'),
						...
						_List_fromArray(
							[
								...
								model,
								A2(elm_community$list_extra$List$Extra$find, author$project$Main$isHuman, model.players))
							]))
					])),
				A2(
				rundis$elm_bootstrap$Bootstrap$Grid$row,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('pokerFooter')
							]))
					]),
				_List_fromArray(
					[
						author$project$Main$handInfoText(model)
					]))
			]));
};
